...
from schemas import ProviderCreate, ProviderLogin, Response, PatientCreate, LoginToken, ProviderDashboardStats, PatientData, LogData, ChartAnalytics, DiagnosisCreate, ChangePasswordSchema
...
async def change_password(
    ...
    return await AuthenticationService.change_password(password_data.email, password_data, db)

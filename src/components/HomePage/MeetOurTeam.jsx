...
// Responsive breakpoints (3 slides at all times on large screens)
const responsive = {
...
const MeetOurTeam = ({teamRef}) => {
    return (
        <section ref={teamRef} className="pt-20 pb-10 px-6 md:px-16 mb-[3rem] text-center w-full">
            ...
            {/* Responsive Carousel (Centered on Small Screens) */}
                ...
                >
                    {teamMembers.map((member, index) => (
                        ...
                        >
                            <Card
                                hoverable
                                className="shadow-md rounded-xl overflow-hidden p-4 my-6 bg-white max-w-xs mx-auto"
                            >
                                <Image
                                    src={member.image}
                                    alt={member.name}
